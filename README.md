...
Built for the **TxODDS TxLINE Hackathon** — powered end-to-end by **TxODDS TxLINE** live sports data on **Solana**.
...
Fantasy is too slow. Betting is not for everyone. Dashboards are boring. PULSE creates a new category: **moment-to-moment intuition validation**.
...
| 🏆 **Leaderboards** | Points leaderboard for predictors + a separate accuracy leaderboard for scratchers |
...
3. **Predict** — feel something coming? Tap **YES – action!** (or **NO – calm**). A 60-second timer starts. Real TxODDS TxLINE data resolves it: goal = 3× points, red card = 2.5×, yellow = 2×, corner = 1.5×. Streaks stack bonuses.
...
6. **Replay** — between matches, open **Replay** and play historical scenarios at 1×/2×/4× speed. No sign-in needed.
...
**For fans** — 5 billion people watch football; almost none have a legal, free way to *test* their game-reading skill in the moment. PULSE gives every fan — in every jurisdiction, at any age — a skill-based stake in every minute of a match, with zero financial risk. It converts passive watching into active engagement.
...
Built for the TxODDS TxLINE World Cup Hackathon 2026.
